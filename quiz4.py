...
for ind in range(1,7):
    ...
    for car in cars_item:
        ...
        file_obj.writerow([name, features, pricegel_usd+'$'])
...
#p.s ფასი ძალიან 'მახინჯურად მაქვს' სხვანაირად ვერ მოვახერხე :დ :/
#სამწუხაროდ 4 მახასიათებელი ერთად მოაქვს, სხვანაირად ვერ მოხერხდა :/ :/
